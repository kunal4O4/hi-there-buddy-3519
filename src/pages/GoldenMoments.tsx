...
const GoldenMoments = () => {
  ...
  const handleShare = (moment: any) => {
    ...
    const shareUrl = `${window.location.origin}/golden-moments`;
    if (navigator.share) {
      navigator.share({
        title: moment.title,
        text: shareText,
  ...
  return <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Modals */}
        <MomentDetailsModal moment={selectedMoment} isOpen={showDetailsModal} onClose={() => setShowDetailsModal(false)} onLike={handleLike} onBookmark={handleBookmark} onShare={handleShare} likedMoments={likedMoments} bookmarkedMoments={bookmarkedMoments} />
