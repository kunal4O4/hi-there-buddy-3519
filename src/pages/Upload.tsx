...
import { Camera, Upload as UploadIcon, X, MapPin, Calendar, Users, Tag, Image } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `${files.length} photos uploaded successfully. Your memories are now part of the gallery!`,
      });
